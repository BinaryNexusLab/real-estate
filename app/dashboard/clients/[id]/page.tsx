      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        <Card className="bg-card border-border mb-6">
          <CardHeader className="border-b border-border">
            <div className="flex items-start justify-between">
              <div>
                ...
                <CardDescription className="text-muted-foreground mt-1">{client.email}</CardDescription>
              </div>
          ...
          <CardContent className="pt-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <p className="text-sm text-muted-foreground mb-1">Investment Budget</p>
                <p className="text-3xl font-bold text-primary">${(client.budget / 1000).toFixed(0)}k</p>
                <p className="text-xs text-muted-foreground mt-2">AUD</p>
              </div>
              <div>
                <p className="text-sm text-muted-foreground mb-1">Annual Salary</p>
                <p className="text-3xl font-bold text-accent">${(client.salary / 1000).toFixed(0)}k</p>
                <p className="text-xs text-muted-foreground mt-2">
                  Debt-to-Income Ratio: {((client.budget / client.salary) * 100).toFixed(0)}%
                </p>
              </div>
            </div>
          </CardContent>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <Card className="bg-card border-border">
            <CardHeader>
              <CardTitle className="text-foreground">Investment Profile</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div>
                <p className="text-sm text-muted-foreground">Investment Goal</p>
                <p className="font-semibold text-foreground text-lg">{client.investmentGoal}</p>
              </div>
              <div>
                <p className="text-sm text-muted-foreground">Investment Period</p>
                <p className="font-semibold text-foreground text-lg">{client.investmentPeriod} years</p>
              </div>
              <div>
                <p className="text-sm text-muted-foreground">Preferred Location</p>
                <p className="font-semibold text-foreground text-lg">{client.preferredLocation}</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-card border-border">
            <CardHeader>
              <CardTitle className="text-foreground">Financial Metrics</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div>
                <p className="text-sm text-muted-foreground">Loan Serviceability</p>
                <p className="font-semibold text-foreground text-lg">
                  {(client.salary / 4 > client.budget * 0.05).toString() === "true" ? "Good" : "Risk"}
                </p>
              </div>
              <div>
              ...
              <div>
                <p className="text-sm text-muted-foreground">Likely Loan Amount</p>
                <p className="font-semibold text-foreground text-lg">${((client.budget * 0.8) / 1000).toFixed(0)}k</p>
              </div>
            </CardContent>
          </Card>
        </div>
